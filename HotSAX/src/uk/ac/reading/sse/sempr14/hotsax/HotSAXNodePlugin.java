 ...
 *
 */
package uk.ac.reading.sse.sempr14.hotsax;
 ...
 */
public class HotSAXNodePlugin extends Plugin {
    // The shared instance.
    private static HotSAXNodePlugin plugin;

    /**
     * The constructor.
     */
    public HotSAXNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static HotSAXNodePlugin getDefault() {
        return plugin;
    }
